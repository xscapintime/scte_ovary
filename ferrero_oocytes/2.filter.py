...
# %%
## violin plot
adata.obs['type'] = 'oocyte'
sc.pl.violin(adata, ['n_genes', 'n_counts'], groupby='type', size=0, log=False, cut=0, show=False, save='qc1-pre-norm-type.pdf')

# %%
# Base filtering for QC failures:
sc.pp.filter_cells(adata, min_genes=20000)
...
sc.pl.violin(adata, ['n_genes','n_counts'], groupby='type', size=0, log=False, cut=0, show=False, save='qc1-type.pdf')
