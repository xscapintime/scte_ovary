...
sc.settings.figdir = 'figures-tes'
...
marker_genes_dict = {
    'Epiblast/Primitive streak': ["Pou5f1", "Epcam", 'ETnERV-int', 'RLTR13G', 'ERVB7_1-LTR_MM'],
...
sc.pl.heatmap(adata, marker_genes_dict, groupby='leiden_r0.5', show=False, save='markers.pdf')
